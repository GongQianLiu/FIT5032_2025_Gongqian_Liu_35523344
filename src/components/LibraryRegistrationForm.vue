...
/**
 * Validates the reason text and shows a message if it contains the word 'friend'
 */
...
/**
 * Validates the reason text length
 * @param blur: boolean - If true, the function will display an error message if the text is too short
 */
const validateReasonLength = (blur) => {
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <textarea
              ...
              @blur="() => validateReasonLength(true)"
              @input="() => validateReasonLength(false)"
            ></textarea>
